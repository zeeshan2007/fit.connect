    ...
    <div className="pt-20 md:pt-24 min-h-screen dark:bg-surface bg-surface-light">
      <div className="max-w-2xl mx-auto px-4 md:px-8 py-8 md:py-12">
        <AnimatedSection className="text-center mb-8">
          <h1 className="font-heading text-3xl md:text-display-sm font-bold uppercase tracking-wider mb-2">
              ...
              >
                ...
                {step === 0 && (
                  <div className="space-y-5">
                    <h2 className="font-heading text-lg uppercase tracking-wider font-bold mb-4">Personal Info</h2>
                    <div>
                ...
                {step === 1 && (
                  <div className="space-y-5">
                    <h2 className="font-heading text-lg uppercase tracking-wider font-bold mb-4">Your Goals</h2>
                    <div>
                          ...
                          <button
                            ...
                            className={`py-3 px-4 rounded-xl border text-sm font-medium transition-all duration-300 ${
                              form.sessionType === type
                                ...
                                : 'dark:border-border border-border-light dark:hover:border-accent/50 hover:border-accent/50'
                            }`}
                          >
                            {type === 'Online' ? '💻' : '🏢'} {type}
                          </button>
                ...
                {step === 2 && (
                  <div className="space-y-5">
                    <h2 className="font-heading text-lg uppercase tracking-wider font-bold mb-4">Schedule</h2>
                    <div>
